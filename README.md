...
> 10 самых частых тематик обращений определили с помощью сводной таблицы, расположив в строки столбец "Тиматика" в значения - "id" (по количеству). Использовали фильтр по значению, для визуализации выбрали наиболее подходящую, линейчатую диаграмму.
> лорлорло  
