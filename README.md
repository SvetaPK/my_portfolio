...
> Задача №1
> 10 самых частых тематик обращений определили с помощью сводной таблицы, расположив в строки - столбец "Тиматика", в значения - "id" (по количеству). Для определения 10 самых частых использовали фильтр по значению. Для визуализации выбрали наиболее подходящую, линейчатую диаграмму. Диаграмму динамики по дням построили по сводной таблице, расположив в строки - "Дату", в столбцы - "Тематику", в значения - "id" (по количеству). Использовали фильтр для определения 3-топ  10 самых частых . Для визуализации выбрали наиболее подходящую, линейчатую диаграмму.
> лорлорло  
