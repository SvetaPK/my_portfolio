...
>
> Для визуализации юнит-экономики использовали круговую диаграмму для фактических показателей и плановых.
> Создадим график - комбинированную диаграмму с "Выручкой" и "Количеством студентов" по месяцам.
